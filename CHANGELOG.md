...
- **Add durable concurrent provider-cost and request admission with retained reservations for unknown outcomes**

## 0.14.0 — 2026-09-16

### Added

- **Represent uncapped embedding plans separately from application budgets and report refused embeddings without assuming monthly exhaustion** (`EmbeddingUsageSnapshot`, `readProviderBalances`)

## 0.13.1 — 2026-09-13

### Fixed

- **Ship a precompiled universal Vue credit picker and scoped CSS so consumers do not compile package SFCs into colliding client/server output paths.**
